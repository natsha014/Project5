    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='study.course', verbose_name='Оплаченный курс')),
                ('paid_lesson', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='study.lesson', verbose_name='Оплаченный урок')),
